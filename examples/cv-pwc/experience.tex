  ...
  \cventry
    ...
    {Mars 2026 -- Septembre 2026}
    {
      \begin{cvitems}
        ...
        \item {Développement de services et d’API REST en Python/FastAPI avec MongoDB et création d’une interface React/Next.js permettant aux chercheurs d’interagir avec l’agent.}
