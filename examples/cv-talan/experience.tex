...
\begin{cventries}
  \cventry
    ...
    {
      \begin{cvitems}
        \item {Conception et développement en autonomie d’un agent d’IA multi-étapes destiné aux chercheurs, avec le suivi de mes encadrants, intégrant l’API OpenAI et l’orchestration d’outils.}
        ...
        \item {Responsable d’une application web conteneurisée avec Docker, permettant d’installer des LLM locaux exécutés sur un Mac Studio.}
