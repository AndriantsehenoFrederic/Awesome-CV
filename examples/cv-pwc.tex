...
\position{Ingénieur IA{\enskip\cdotp\enskip}FullStack, GenAI}
...
\input{cv-pwc/summary.tex}
\input{cv-pwc/experience.tex}
\input{cv-pwc/skills.tex}
\input{cv-pwc/education.tex}
\end{document}
