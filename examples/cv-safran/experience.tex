...
\begin{cventries}
  \cventry
    ...
    {
      \begin{cvitems}
        \item {Développement de services et d’API REST en Python/FastAPI avec MongoDB et OpenAPI, et d’une interface React/Next.js permettant aux chercheurs d’interagir avec l’agent.}
