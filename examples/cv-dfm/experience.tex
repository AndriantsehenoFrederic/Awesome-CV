  ...
  \cventry
    ...
    {Mars 2026 -- Septembre 2026}
    {
      \begin{cvitems}
        ...
        \item {Développement du backend et d’API REST en Python/FastAPI avec MongoDB ainsi que d’une interface React/Next.js destinée aux utilisateurs.}
        ...
        \item {Mise en place de webhooks pour transmettre les résultats de tâches planifiées et développement d’un outil de collecte automatisée de métadonnées scientifiques.}
