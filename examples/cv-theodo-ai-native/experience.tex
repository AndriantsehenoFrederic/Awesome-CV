  ...
  \cventry
    ...
    {Mars 2026 -- Septembre 2026}
    {
      \begin{cvitems}
        ...
        \item {Développement du backend et d’API REST en Python/FastAPI avec MongoDB ainsi que d’une interface React/Next.js permettant aux chercheurs d’utiliser l’application.}
