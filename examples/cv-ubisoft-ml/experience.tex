  ...
  \cventry
    ...
    {Mars 2026 -- Septembre 2026}
    {
      \begin{cvitems}
        ...
        \item {Comparaison de Qwen, Gemma et GLM sur une infrastructure HPC avec Slurm selon la latence, le TTFT, la qualité des réponses et la taille du contexte.}
        \item {Évaluation de plusieurs configurations de quantification afin d’identifier le meilleur compromis entre performances d’inférence et qualité des réponses selon l’environnement d’exécution des modèles.}
        \item {Définition du protocole expérimental, analyse des résultats et rédaction d’un article scientifique présentant l’évaluation des modèles.}
